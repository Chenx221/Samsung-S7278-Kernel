...
#define ctx_arch_id_off 680 /* offsetof(NkOsCtx, arch_id)	@ */
...
#define ctx_cpsr_off 128 /* offsetof(NkOsCtx, cpsr)	@ */
#define ctx_vfp_owned_off 672 /* offsetof(NkOsCtx, vfp_owned)	@ */
#define ctx_vfp_get 2452 /* offsetof(NkOsCtx, vfp_get)	@ */
