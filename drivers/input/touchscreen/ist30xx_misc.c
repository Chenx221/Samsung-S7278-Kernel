...
/* sysfs  */
static DEVICE_ATTR(mem, S_IWUSR | S_IWGRP | S_IRUGO, ist30xx_mem_show, ist30xx_mem_store);
...
static DEVICE_ATTR(clb, S_IWUSR | S_IWGRP | S_IRUGO, ist30xx_calib_show, ist30xx_calib_store);
static DEVICE_ATTR(debug, S_IWUSR | S_IWGRP , NULL, ist30xx_debug_store);
static DEVICE_ATTR(tsp_power, S_IWUSR | S_IWGRP , NULL, ist30xx_power_store);
static DEVICE_ATTR(errcnt, S_IWUSR | S_IWGRP, NULL, ist30xx_errcnt_store);
static DEVICE_ATTR(printk, S_IWUSR | S_IWGRP | S_IRUGO, ist30xx_printk_show, ist30xx_printk_store);

static DEVICE_ATTR(regcmd, S_IWUSR | S_IWGRP | S_IRUGO, tunes_regcmd_show, tunes_regcmd_store);
static DEVICE_ATTR(reg, S_IWUSR | S_IWGRP | S_IRUGO, tunes_reg_show, tunes_reg_store);
static DEVICE_ATTR(tunes_fw, S_IWUSR | S_IWGRP, NULL, tunes_fw_store);
static DEVICE_ATTR(tunes_param, S_IWUSR | S_IWGRP , NULL, tunes_param_store);
static DEVICE_ATTR(adb, S_IWUSR | S_IWGRP | S_IRUGO, tunes_adb_show, tunes_adb_store);
