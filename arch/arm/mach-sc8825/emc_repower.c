...
static inline void restore_ddr_scan_reg(struct emc_repower_param *param)
{
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX0DLLCR) &= ~(0xf << 14);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX0DLLCR) |= param->DX0DLLCR << 14;
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX1DLLCR) &= ~(0xf << 14);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX1DLLCR) |= param->DX1DLLCR << 14;
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX2DLLCR) &= ~(0xf << 14);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX2DLLCR) |= param->DX2DLLCR << 14;
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX3DLLCR) &= ~(0xf << 14);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX3DLLCR) |= param->DX3DLLCR << 14;

	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX0DQSTR) &= ~(0x3f << 20);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX0DQSTR) |= (param->DX0DQSTR << 20);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX1DQSTR) &= ~(0x3f << 20);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX1DQSTR) |= (param->DX1DQSTR << 20);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX2DQSTR) &= ~(0x3f << 20);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX2DQSTR) |= (param->DX2DQSTR << 20);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX3DQSTR) &= ~(0x3f << 20);
	REG32(PUBL_REG_BASE + PUBL_CFG_ADD_DX3DQSTR) |= (param->DX3DQSTR << 20);
}
...
//	u32 publ_base;
	...
	param->DX0DLLCR = (REG32(publ_base + PUBL_CFG_ADD_DX0DLLCR) >> 14) & 0xf;
	param->DX1DLLCR = (REG32(publ_base + PUBL_CFG_ADD_DX1DLLCR) >> 14) & 0xf;
	param->DX2DLLCR = (REG32(publ_base + PUBL_CFG_ADD_DX2DLLCR) >> 14) & 0xf;
	param->DX3DLLCR = (REG32(publ_base + PUBL_CFG_ADD_DX3DLLCR) >> 14) & 0xf;

	param->DX0DQSTR = (REG32(publ_base + PUBL_CFG_ADD_DX0DQSTR) >> 20) & 0x3f;
	param->DX1DQSTR = (REG32(publ_base + PUBL_CFG_ADD_DX1DQSTR) >> 20) & 0x3f;
	param->DX2DQSTR = (REG32(publ_base + PUBL_CFG_ADD_DX2DQSTR) >> 20) & 0x3f;
	param->DX3DQSTR = (REG32(publ_base + PUBL_CFG_ADD_DX3DQSTR) >> 20) & 0x3f;
